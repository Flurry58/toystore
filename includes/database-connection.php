...
$db = "loganpol_toystore"; // Name of the database
$port = "3306"; // Port is usually 3306 in Hostgator
$charset = "utf8mb4"; // UTF-8 encoding using 4 bytes of data per char

$username = "loganpol_mainuser"; // Enter YOUR cPanel username and user here
$password = "Lcp35177-2023"; // Enter YOUR user password here
// Old Password: DXyCF6Jd9E2omWoMrSU
